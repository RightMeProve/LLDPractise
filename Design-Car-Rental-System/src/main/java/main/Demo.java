...
/**
 * Main Demo class to showcase the overall functionality of the Car Rental System.
 * Simulates a real-world scenario where users interact with stores,
 * vehicles are added to inventory, reservations are made, and bills are paid.
 */
public class Demo {
