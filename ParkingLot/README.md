...
## 📌 High-Level Overview
The Parking Lot system is designed to handle multiple levels (floors), multiple vehicle types (Two-Wheeler, Four-Wheeler), and distinct entry and exit points. 
